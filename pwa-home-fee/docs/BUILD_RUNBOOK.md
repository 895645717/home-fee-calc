...
- Project: `C:\Projects\daily_slills\home-fee-calc`
...
- If lock errors appear, clear leftover Java or Gradle processes and retry.
- Keep `android/app/build.gradle` as UTF-8 without BOM.
- Do not switch the main Gradle cache to `C:\Users\zhouqiyu\.gradle` for this project.
